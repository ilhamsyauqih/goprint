    ...
    return Scaffold(
      ...
      body: shopAsync.when(
          ...
          return ordersAsync.when(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RecentOrderList(orders: allOrders),
            ...
            error: (err, stack) => Center(
              child: Padding(
                ...
                child: Text('Gagal memuat data pesanan: $err'),
              ),
            ),
          );
        },
        ...
        error: (err, stack) => Center(
          child: Padding(
            padding: const EdgeInsets.all(40.0),
            child: Text('Gagal memuat toko: $err'),
          ),
        ),
      ),
    );
